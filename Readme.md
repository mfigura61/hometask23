...
## Проверка модифицированного стенда:


 Мы модифицировали стандартный стенд, изменив вагрант-файл и внеся изменения в ансибл плейбук
 После отработки vagrant up можно повыполнять dns запросы на client и client2.

Для виртуалки client имеем видимость зон:
```
...
```
Проверим доступность для client2:
```
...
```
Для проверки просто делаем vagrant up.
